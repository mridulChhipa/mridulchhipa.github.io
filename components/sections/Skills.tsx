      ...
      <div style={{ maxWidth: 1120, margin: "0 auto", display: "flex", flexDirection: "column", gap: 36, position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(320px, 100%), 1fr))", gap: 24 }}>
          <div style={cardStyle}>
            ...
            <StatBar label="C++ / systems" value={95} />
            <StatBar label="Algorithms / CP" value={92} />
            <StatBar label="Python / ML" value={93} />
            <StatBar label="React / full-stack" value={90} />
            <StatBar label="Verilog / FPGA" value={90} />
          </div>
